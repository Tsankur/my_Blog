...
{
	src:o.src,alt:o.alt,width:o.width,height:o.height,style:o.style,"class":o["class"]
}
...
,p=a.dom,q=a.selection.getNode(),r=a.settings.image_dimensions!==!1;
...
{
	src:p.getAttrib(q,"src"),alt:p.getAttrib(q,"alt"),"class":p.getAttrib(q,"class"),width:k,height:l
}
,d&&(m=
{
...
{
	title:"Insert/edit image",data:o,bodyType:"tabpanel",body:[
{
...
{
	type:"textbox",maxWidth:50,onchange:i
}
,items:[
{
...
{
	title:"Insert/edit image",data:o,body:s,onSubmit:f
}
)
}
a.addButton("image",
{
	icon:"image",tooltip:"Insert/edit image",onclick:d(e),stateSelector:"img:not([data-mce-object],[data-mce-placeholder])"
}
),a.addMenuItem("image",
{
	icon:"image",text:"Insert image",onclick:d(e),context:"insert",prependToContext:!0
}
